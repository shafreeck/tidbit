...
func (s *testSnapshotSuite) TestSnapshotCache(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/shafreeck/tidbit/tikv/snapshot-get-cache-fail", `return(true)`), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/shafreeck/tidbit/tikv/snapshot-get-cache-fail"), IsNil)
}
