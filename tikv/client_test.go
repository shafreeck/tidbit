...
func (s *testClientSuite) TestIdleHeartbeat(c *C) {
	...
	sendIdleReq := "github.com/shafreeck/tidbit/tikv/sendIdleHeartbeatReq"
	noStripResp := "github.com/shafreeck/tidbit/tikv/forceReturnIdleHeartbeatResp"
	noAvConn := "github.com/shafreeck/tidbit/tikv/noAvConn"
	failBeforeSend := "github.com/shafreeck/tidbit/tikv/failBeforeSend"
