...
func (s *testGCWorkerSuite) TestResolveLockRangeInfine(c *C) {
	c.Assert(failpoint.Enable("github.com/shafreeck/tidbit/tikv/invalidCacheAndRetry", "return(true)"), IsNil)
	c.Assert(failpoint.Enable("github.com/shafreeck/tidbit/tikv/gcworker/setGcResolveMaxBackoff", "return(1)"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("github.com/shafreeck/tidbit/tikv/invalidCacheAndRetry"), IsNil)
		c.Assert(failpoint.Disable("github.com/shafreeck/tidbit/tikv/gcworker/setGcResolveMaxBackoff"), IsNil)
	}()
